...
import { PostsSearchBar } from "./search-input";
...
export const AllBlogsList = () => {
  ...
  const defaultImageUrl =
    "https://conasems-ava-prod.s3.sa-east-1.amazonaws.com/institucional/congressos/02-banner-principal-1682519362.png";
          ...
          posts?.response?.docs?.slice(1)?.map((post, index) => (
            <div className="pb-10" key={post.slug}>
              ...
              <p className="text-sm text-orange-500 my-4">
                {convertDate(post.startDate)}
              </p>
              <h3 className="text-2xl md:text-lg mb-3">
